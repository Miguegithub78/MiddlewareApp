    ...
    <div className="">
      ...
      <form id="form1">
        ...
        <div className="form-group">
          {product === "Standard" ? <span>Obtendrás con este paquete un buen posicionamiento en las búsquedas por una semana</span> : <span>Obtendrás con este paquete un excelente posicionamiento en las búsquedas por un mes</span>}
          <div>
